...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-1-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-2-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-3-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-4-1.png}}
\end{frame}

\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-5-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-6-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-7-1.png}}
\end{frame}
...
\begin{frame}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../../images/regressao/bagging.png}}
\end{center}
\end{frame}
...
\begin{frame}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../../images/regressao/rf.png}}
\end{center}
\end{frame}

\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-10-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-13-1.png}}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-16-1.png}}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../../images/regressao/rna.png}}
\end{center}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-17-1.png}}
\end{block}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../../images/regressao/neuronioMP2.png}}
\end{center}
\end{block}
\end{frame}
...
\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-18-1.png}}
\end{frame}

\begin{frame}
\pandocbounded{\includegraphics[keepaspectratio]{met_nao_param_files/figure-beamer/unnamed-chunk-19-1.png}}
\end{frame}
...
\begin{frame}{Flexibilidade vs Eficiência}
\phantomsection\label{flexibilidade-vs-eficiuxeancia}
\begin{columns}[T]
\begin{column}{0.5\linewidth}
...
\phantomsection\label{muxe9todos-nuxe3o-paramuxe9tricos}
\begin{itemize}
\tightlist
\item
  alta flexibilidade\\
...
👉 \textbf{Taxa de convergência} = velocidade com que o \textbf{erro
diminui} à medida que \textbf{aumentamos o tamanho da amostra}.
\end{frame}

\begin{frame}
\textbf{Observação:} o parâmetro \(\alpha\) é a \textbf{taxa de
suavidade} de \(r(x)\), ou seja, quão ``regular'' ou ``sem variações
bruscas'' é a função de regressão.

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, left=2mm, colback=white, arc=.35mm, breakable, toprule=.15mm, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Definição (um pouco) mais formal}, rightrule=.15mm, bottomrule=.15mm]
...
\tightlist
\item
  \textbf{Mais suavidade} = menos dados necessários\\
\item
  \textbf{Menos suavidade} = mais dados necessários
\end{itemize}
\end{frame}
